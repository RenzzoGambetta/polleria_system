...
//--> Modulo de autentificacion
    ...
    Route::post('/login_validate', [LoginController::class,'login'])->name('login_validate');
    ...
    Route::middleware( 'auth')->group(function () {
        ...
        Route::middleware(['auth', 'permission:1'])->group(function () {
            ...
            Route::get('/list_of_employer', [EmployeeController::class,'listOfEmployer'])->name('list_of_employer');
            ...
            Route::get('/list_of_role', [RoleController::class,'listOfRole'])->name('list_of_role');
        ...
        //--> Modulo de gestion de inventario
            ...
            Route::post('/anchor_supply_provider', [SupplyStockController::class,'anchorSupplyProvider'])->name('anchor_supply_provider');
            Route::post('/remove_supply_provider', [SupplyStockController::class,'removeSupplyProvider'])->name('remove_supply_provider');
        ...
        //--> Modulo de gestion de Menu
            ...
            Route::post('/new_menu_categories', [MenuController::class,'newMenuCategories'])->name('new_menu_categories');
        ...
        Route::middleware(['auth', 'permission:7,8'])->group(function () {
        //--> Order
            //PointOfSale
    ...
    //--> Home
        ...
        Route::get('/home', [HomeController::class,'showHomePanel'])->name('home');
        Route::get('/zona-no-autorisada', [HomeController::class,'unauthorizedZone'])->name('zona_no_autorisada');
